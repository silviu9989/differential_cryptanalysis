...
int main () {
    ...
    int guessed_k = ((row&0b1)<<8) + ((row&0b10)<<9) + ((row&0b100)<<10) + ((row&0b1000)<<11) + (column&0b1) + ((column&0b10)<<1) + ((column&0b100)<<2) + ((column&0b1000)<<3);
    printf("After the first step, the guess is that k3=%x. \n", guessed_k);
    ...
    int guessed_k2 = ((row&0b1)<<9) + ((row&0b10)<<10) + ((row&0b100)<<11) + ((row&0b1000)<<12) + ((column&0b1)<<1) + ((column&0b10)<<2) + ((column&0b100)<<3) + ((column&0b1000)<<4);
    printf("After the second step, the guess is that k=%x.\n", guessed_k2);
